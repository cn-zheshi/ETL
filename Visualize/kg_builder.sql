...
CREATE TABLE `kg_category`  (
  ...
  `FileName` varchar(500) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '节点来源附件',
...
CREATE TABLE `kg_nodedetail_file`  (
  ...
  `DomainId` int(11) NULL DEFAULT NULL COMMENT '知识图谱领域主键',
  `NodeId` int(11) NULL DEFAULT NULL COMMENT '关系定义主键',
  `FileName` varchar(500) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '若是本地上传则为文件名称，若是网络链接则保存为链接',
